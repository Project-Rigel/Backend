...
import { GetAgendaConfigDto } from '../../../src/agendas/application/dto/get-agenda-config.dto';
import { GetAgendaConfigUseCase } from '../../../src/agendas/application/get-agenda-config';
